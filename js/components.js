  ...
  checkLoginStatus() {
    ...
    if (token) {
      ...
      authContainer.innerHTML = `
        <a href="/mypage" class="flex items-center gap-2 px-6 py-2.5 rounded-full bg-primary hover:bg-primary-hover text-white text-sm font-semibold transition-all shadow-[0_4px_14px_0_rgba(16,185,129,0.39)] hover:shadow-[0_6px_20px_rgba(16,185,129,0.23)] hover:-translate-y-0.5 font-body tracking-wide">
          <span>MYPAGE</span>
        </a>
